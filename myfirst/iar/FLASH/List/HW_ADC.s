///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.30.1.7746/W32 for ARM       30/May/2015  13:27:59
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_ADC.c
//    Command line =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_ADC.c
...
//    List file    =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\project\myfirst\iar\FLASH\List\HW_ADC.s
//
///////////////////////////////////////////////////////////////////////////////
...
??LPLD_ADC_Chn_Enable_2:
        LDR.N    R0,??DataTable12_5  ;; 0x400bb000
        CMP      R2,R0
...
??LPLD_ADC_Chn_Enable_26:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable12_12  ;; 0x40049000
        SXTB     R1,R1            ;; SignExt  R1,R1,#+24,#+24
        STR      R0,[R4, R1, LSL #+2]
//  716         break;
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_45:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable12_13  ;; 0x40049018
        STR      R0,[R4, #+0]
//  798         break;     
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_46:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable12_14  ;; 0x4004d070
        STR      R0,[R4, #+0]
//  801         break;       
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_49:
        MOVS     R0,#+0
        LDR.N    R4,??DataTable12_15  ;; 0x4004902c
        STR      R0,[R4, #+0]
//  814         break;
        B.N      ??LPLD_ADC_Chn_Enable_15
