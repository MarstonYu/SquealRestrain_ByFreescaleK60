///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.30.1.7746/W32 for ARM       22/May/2015  18:23:06
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_FTM.c
//    Command line =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_FTM.c
...
//    List file    =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\project\myfirst\iar\RAM\List\HW_FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  938         PORTD->PCR[5] = PORTD->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable11  ;; 0x4004c014
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_28
//  939       else
//  940         return 0;
...
//  944         PORTA->PCR[1] = PORTA->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable11_1  ;; 0x40049004
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable11_1  ;; 0x40049004
        STR      R0,[R4, #+0]
...
//  946         PORTD->PCR[6] = PORTD->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable12  ;; 0x4004c018
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12  ;; 0x4004c018
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_31
//  947       else
//  948         return 0;
...
//  952         PORTA->PCR[2] = PORTA->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15  ;; 0x40049008
        STR      R0,[R4, #+0]
...
//  954         PORTD->PCR[7] = PORTD->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable15_1  ;; 0x4004c01c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_34
//  955       else
//  956         return 0;
...
??LPLD_FTM_PinInit_0:
        LDR.W    R0,??DataTable10_13  ;; 0x40039000
        CMP      R3,R0
...
//  968         PORTA->PCR[8] = PORTA->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_2  ;; 0x40049020
        STR      R0,[R4, #+0]
...
//  970         PORTA->PCR[12] = PORTA->PCR[12] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_3  ;; 0x40049030
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_43
...
//  972         PORTB->PCR[0] = PORTB->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_4  ;; 0x4004a000
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_43
//  973       else
//  974         return 0;
...
//  978         PORTA->PCR[9] = PORTA->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_5  ;; 0x40049024
        STR      R0,[R4, #+0]
...
//  980         PORTA->PCR[13] = PORTA->PCR[13] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_6  ;; 0x40049034
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_47
...
//  982         PORTB->PCR[1] = PORTB->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_7  ;; 0x4004a004
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_47
//  983       else
//  984         return 0;
...
??LPLD_FTM_PinInit_36:
        LDR.W    R0,??DataTable10_14  ;; 0x400b8000
        CMP      R3,R0
...
// 1015         PORTA->PCR[10] = PORTA->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_8  ;; 0x40049028
        STR      R0,[R4, #+0]
...
// 1017         PORTB->PCR[18] = PORTB->PCR[18] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_9  ;; 0x4004a048
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_64
// 1018       else
// 1019         return 0;
...
// 1023         PORTA->PCR[11] = PORTA->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_10  ;; 0x4004902c
        STR      R0,[R4, #+0]
...
// 1025         PORTB->PCR[19] = PORTB->PCR[19] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_11  ;; 0x4004a04c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_67
// 1026       else
// 1027         return 0;
...
// 1057         PORTE->PCR[5] = PORTE->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_13  ;; 0x4004d014
        STR      R0,[R4, #+0]
...
// 1059         PORTD->PCR[0] = PORTD->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable15_14  ;; 0x4004c000
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_86
// 1060       else
// 1061         return 0;
...
// 1065         PORTE->PCR[6] = PORTE->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_15  ;; 0x4004d018
        STR      R0,[R4, #+0]
...
// 1067         PORTD->PCR[1] = PORTD->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable15_16  ;; 0x4004c004
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_89
// 1068       else
// 1069         return 0;
...
// 1073         PORTE->PCR[7] = PORTE->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_17  ;; 0x4004d01c
        STR      R0,[R4, #+0]
...
// 1075         PORTD->PCR[2] = PORTD->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable15_18  ;; 0x4004c008
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_92
// 1076       else
// 1077         return 0;
...
// 1081         PORTE->PCR[8] = PORTE->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_19  ;; 0x4004d020
        STR      R0,[R4, #+0]
...
// 1083         PORTD->PCR[3] = PORTD->PCR[3] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable15_20  ;; 0x4004c00c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_95
// 1084       else
// 1085         return 0;
...
// 1089         PORTE->PCR[9] = PORTE->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_21  ;; 0x4004d024
        STR      R0,[R4, #+0]
...
// 1091         PORTC->PCR[8] = PORTC->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_22  ;; 0x4004b020
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_98
// 1092       else
// 1093         return 0;
...
// 1097         PORTE->PCR[10] = PORTE->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_23  ;; 0x4004d028
        STR      R0,[R4, #+0]
...
// 1099         PORTC->PCR[9] = PORTC->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_24  ;; 0x4004b024
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_101
// 1100       else
// 1101         return 0;
...
// 1105         PORTE->PCR[11] = PORTE->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_25  ;; 0x4004d02c
        STR      R0,[R4, #+0]
...
// 1107         PORTC->PCR[10] = PORTC->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_26  ;; 0x4004b028
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_104
// 1108       else
// 1109         return 0;
...
// 1113         PORTE->PCR[12] = PORTE->PCR[12] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R4,??DataTable15_27  ;; 0x4004d030
        STR      R0,[R4, #+0]
...
// 1115         PORTC->PCR[11] = PORTC->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable15_28  ;; 0x4004b02c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_107
// 1116       else
// 1117         return 0;
...
// 1144         PORTA->PCR[3] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_30  ;; 0x4004900c
        STR      R0,[R3, #+0]
...
// 1146         PORTC->PCR[1] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_31  ;; 0x4004b004
        STR      R0,[R3, #+0]
// 1147       break;
...
// 1150         PORTA->PCR[4] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_32  ;; 0x40049010
        STR      R0,[R3, #+0]
...
// 1152         PORTC->PCR[2] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_33  ;; 0x4004b008
        STR      R0,[R3, #+0]
// 1153       break;
...
// 1156         PORTA->PCR[5] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_34  ;; 0x40049014
        STR      R0,[R3, #+0]
...
// 1158         PORTC->PCR[3] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_35  ;; 0x4004b00c
        STR      R0,[R3, #+0]
// 1159       break;
...
// 1162         PORTA->PCR[6] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_36  ;; 0x40049018
        STR      R0,[R3, #+0]
...
// 1164         PORTC->PCR[4] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_37  ;; 0x4004b010
        STR      R0,[R3, #+0]
// 1165       break;
...
// 1168         PORTA->PCR[7] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_38  ;; 0x4004901c
        STR      R0,[R3, #+0]
...
// 1170         PORTD->PCR[4] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_39  ;; 0x4004c010
        STR      R0,[R3, #+0]
// 1171       break;
...
??LPLD_FTM_PinDeinit_7:
        LDR.W    R0,??DataTable15_40  ;; 0x40049000
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
...
// 1174         PORTA->PCR[0] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_40  ;; 0x40049000
        STR      R0,[R3, #+0]
...
// 1176         PORTD->PCR[5] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable11  ;; 0x4004c014
        STR      R0,[R3, #+0]
// 1177       break;
...
// 1180         PORTA->PCR[1] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable11_1  ;; 0x40049004
        STR      R0,[R3, #+0]
...
// 1182         PORTD->PCR[6] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable12  ;; 0x4004c018
        STR      R0,[R3, #+0]
// 1183       break;
...
// 1186         PORTA->PCR[2] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15  ;; 0x40049008
        STR      R0,[R3, #+0]
...
// 1188         PORTD->PCR[7] = PORT_PCR_MUX(0);      
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_1  ;; 0x4004c01c
        STR      R0,[R3, #+0]
// 1189       break;
...
??LPLD_FTM_PinDeinit_0:
        LDR.W    R0,??DataTable15_41  ;; 0x40039000
        CMP      R2,R0
...
// 1200         PORTA->PCR[8] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_2  ;; 0x40049020
        STR      R0,[R3, #+0]
...
// 1202         PORTA->PCR[12] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_3  ;; 0x40049030
        STR      R0,[R3, #+0]
...
// 1204         PORTB->PCR[0] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_4  ;; 0x4004a000
        STR      R0,[R3, #+0]
// 1205       break;
...
// 1208         PORTA->PCR[9] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_5  ;; 0x40049024
        STR      R0,[R3, #+0]
...
// 1210         PORTA->PCR[13] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_6  ;; 0x40049034
        STR      R0,[R3, #+0]
...
// 1212         PORTB->PCR[1] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R3,??DataTable15_7  ;; 0x4004a004
        STR      R0,[R3, #+0]
// 1213       break;
...
// 1226         PORTA->PCR[13] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_6  ;; 0x40049034
        STR      R0,[R3, #+0]
...
// 1228         PORTB->PCR[1] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_7  ;; 0x4004a004
        STR      R0,[R3, #+0]
// 1229       break;
...
??LPLD_FTM_PinDeinit_28:
        LDR.W    R0,??DataTable15_42  ;; 0x400b8000
        CMP      R2,R0
...
// 1240         PORTA->PCR[10] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_8  ;; 0x40049028
        STR      R0,[R3, #+0]
...
// 1242         PORTB->PCR[18] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_9  ;; 0x4004a048
        STR      R0,[R3, #+0]
// 1243       break;
...
// 1246         PORTA->PCR[11] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_10  ;; 0x4004902c
        STR      R0,[R3, #+0]
...
// 1248         PORTB->PCR[19] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_11  ;; 0x4004a04c
        STR      R0,[R3, #+0]
// 1249       break;
...
// 1273         PORTE->PCR[5] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_13  ;; 0x4004d014
        STR      R0,[R3, #+0]
...
// 1275         PORTD->PCR[0] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_14  ;; 0x4004c000
        STR      R0,[R3, #+0]
// 1276       break;
...
// 1279         PORTE->PCR[6] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_15  ;; 0x4004d018
        STR      R0,[R3, #+0]
...
// 1281         PORTD->PCR[1] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_16  ;; 0x4004c004
        STR      R0,[R3, #+0]
// 1282       break;
...
// 1285         PORTE->PCR[7] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_17  ;; 0x4004d01c
        STR      R0,[R3, #+0]
...
// 1287         PORTD->PCR[2] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_18  ;; 0x4004c008
        STR      R0,[R3, #+0]
// 1288       break;
...
// 1291         PORTE->PCR[8] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_19  ;; 0x4004d020
        STR      R0,[R3, #+0]
...
// 1293         PORTD->PCR[3] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_20  ;; 0x4004c00c
        STR      R0,[R3, #+0]
// 1294       break;
...
// 1297         PORTE->PCR[9] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_21  ;; 0x4004d024
        STR      R0,[R3, #+0]
...
// 1299         PORTC->PCR[8] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_22  ;; 0x4004b020
        STR      R0,[R3, #+0]
// 1300       break;
...
// 1303         PORTE->PCR[10] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_23  ;; 0x4004d028
        STR      R0,[R3, #+0]
...
// 1305         PORTC->PCR[9] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_24  ;; 0x4004b024
        STR      R0,[R3, #+0]
// 1306       break;
...
// 1309         PORTE->PCR[11] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_25  ;; 0x4004d02c
        STR      R0,[R3, #+0]
...
// 1311         PORTC->PCR[10] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_26  ;; 0x4004b028
        STR      R0,[R3, #+0]
// 1312       break;
...
// 1315         PORTE->PCR[12] = PORT_PCR_MUX(0); 
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_27  ;; 0x4004d030
        STR      R0,[R3, #+0]
...
// 1317         PORTC->PCR[11] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.N    R3,??DataTable15_28  ;; 0x4004b02c
        STR      R0,[R3, #+0]
// 1318       break;
