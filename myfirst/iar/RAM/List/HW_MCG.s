///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.30.1.7746/W32 for ARM       22/May/2015  18:23:08
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_MCG.c
//    Command line =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_MCG.c
...
//    List file    =  
//        D:\tools\IAR\lapulande\%5B拉普兰德K60固件库%5DLPLD_OSKinetis_V3.10\LPLD_OSKinetis_V3\project\myfirst\iar\RAM\List\HW_MCG.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  360         PMC->REGSC |= PMC_REGSC_ACKISO_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x8
        LDR.N    R1,??LPLD_PLL_Setup_16  ;; 0x4007d002
        STRB     R0,[R1, #+0]
...
??LPLD_PLL_Setup_17:
        ...
        ANDS     R1,R1,#0xF0000
        ORRS     R0,R1,R0
        LDR.N    R1,??LPLD_PLL_Setup_16+0x4  ;; 0x40048044
        STR      R0,[R1, #+0]
...
//  373   MCG->C2 = MCG_C2_RANGE0(1);
        MOVS     R0,#+16
        LDR.N    R1,??LPLD_PLL_Setup_16+0x8  ;; 0x40064001
        STRB     R0,[R1, #+0]
...
//  376   MCG->C1 = MCG_C1_CLKS(2) | MCG_C1_FRDIV(5);
        MOVS     R0,#+168
        LDR.N    R1,??LPLD_PLL_Setup_16+0xC  ;; 0x40064000
        STRB     R0,[R1, #+0]
...
//  383   MCG->C6 |= MCG_C6_CME0_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x20
        LDR.N    R1,??LPLD_PLL_Setup_16+0x14  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  384   MCG->C5 = MCG_C5_PRDIV0(prdiv); // 设置 PLL 匹配晶振的参考分频数
        ANDS     R0,R5,#0x7
        LDR.N    R1,??LPLD_PLL_Setup_16+0x18  ;; 0x40064004
        STRB     R0,[R1, #+0]
